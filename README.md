...
A small command-line tool that queries the Internet Archive (Wayback Machine) CDX API to list historical URLs for a target pattern and optionally extract subdomains, path segments, or query parts.

This README explains how the tool works, how to build and run it, the available flags, examples, and a few implementation notes and edge cases based on the source.
...
You can also install it to your GOPATH/bin with:
